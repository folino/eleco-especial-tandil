      ...
      <div className="prose-editorial">
        <FadeIn>
          <p className="text-body-lg text-text-primary leading-relaxed">
            Hay una escena que se repite con sorprendente frecuencia en los últimos años. Una
            pareja, un profesional solo, una familia entera llega a Tandil por primera vez o
            después de varios años de ausencia. Lo que encuentra es una ciudad que creció, que
            se diversificó, que se densificó en algunos puntos y que se expandió hasta las
