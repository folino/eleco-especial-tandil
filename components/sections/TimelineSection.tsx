    ...
    <section ref={sectionRef} className="section-padding bg-section-light noise-overlay">
      <div className="max-w-content mx-auto px-5 md:px-8">
        ...
        <div className="prose-editorial">
          <FadeIn>
            <p>
              La UNICEN, universidad pública creada en 1974 con Tandil como sede central, es el 
              motor silencioso de esa transformación. Su oferta académica abarca diez facultades. 
              A ella se suma el Clúster Tecnológico como asociación empresarial y el ecosistema 
              emprendedor local, conformando los actores fundamentales para el posicionamiento de 
              Tandil como ciudad del conocimiento.
            </p>
          </FadeIn>
        </div>
      </div>
